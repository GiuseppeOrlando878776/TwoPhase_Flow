...
class BubbleMove(TwoPhaseFlows):
    ...
    def build_mesh(self):
        ...
        self.H_int    = Function(self.Qcurv)
    ...
    def set_weak_forms(self):
        try:
            ...
            self.Curvature_weak_form(self.H_curr, self.z, self.H_old, self.H_int, self.u_curr, self.u_old, self.n, self.DT)
